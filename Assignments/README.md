...
allocates a block of memory into a "heap" (not the actual heap of the process, but one that is created by using another function within the library). This block of memory occupies
...
in memory. This block is specified by the void pointer provided to vmfree as a parameter.
